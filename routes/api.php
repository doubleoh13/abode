...
Route::prefix('v1')->middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('financial')->name('financial.')->group(function () {
        Route::middleware('can:view-finances')->group(function () {
            ...
            Route::apiResource('bank-transactions', BankTransactionController::class)->only('index');
        ...
        Route::middleware('can:manage-finances')->group(function () {
            ...
            Route::post('bank-transactions/{bank_transaction}/ignore', [BankTransactionController::class, 'ignore'])->name('bank-transactions.ignore');
            Route::delete('bank-transactions/{bank_transaction}/ignore', [BankTransactionController::class, 'unignore'])->name('bank-transactions.unignore');
        });
    });
});
