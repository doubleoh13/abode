...
- `php artisan migrate:fresh` is the dev reset: it recreates Jake's user, permissions, deterministic API token, and seeded finance data automatically (local only).
